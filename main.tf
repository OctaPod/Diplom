...
resource "yandex_compute_snapshot_schedule" "default" {
  ...
  disk_ids = ["${yandex_compute_instance.vm1.boot_disk.0.disk_id}", "${yandex_compute_instance.vm2.boot_disk.0.disk_id}", "${yandex_compute_instance.vm3.boot_disk.0.disk_id}", "${yandex_compute_instance.vm4.boot_disk.0.disk_id}", "${yandex_compute_instance.elastic.boot_disk.0.disk_id}", "${yandex_compute_instance.kibana.boot_disk.0.disk_id}", "${yandex_compute_instance.bastion.boot_disk.0.disk_id}"]
}
